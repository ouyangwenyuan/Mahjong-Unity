    ...
    internal class AppInvites : MenuBase
    {
        protected override void GetGui()
        {
            if (this.Button("Android Invite"))
            {
                ...
                FB.Mobile.AppInvite(new Uri("https://fb.me/1856664214576117"), callback: this.HandleResult);
            }

            if (this.Button("Android Invite With Custom Image"))
            {
                this.Status = "Logged FB.AppEvent";
                FB.Mobile.AppInvite(new Uri("https://fb.me/1856664214576117"), new Uri("http://i.imgur.com/zkYlB.jpg"), this.HandleResult);
            }
