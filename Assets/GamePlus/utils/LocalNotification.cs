...
class LocalNotification
{
    ...
    private static string fullClassName = Application.bundleIdentifier+".UnityNotificationManager";
    private static string mainActivityClassName = Application.bundleIdentifier+".GamePlusActivity";
#endif
